...
import classifier.util.parser.PaginaURL;
import classifier.util.string.PorterStemmer;
...
//              }
  ...
  public static void main(String[] args) {
        ...
        try {
            StopList st = new classifier.util.string.StopListArquivo(args[0]);
